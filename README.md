# Lohnsteuertabellen-Ersteller 2026
...
| --- | --- | --- |
| **Jahr** | 2026 | Tarifzahl für BMF-Parame |
...
### Blatt „Lohnsteuer_Rohdaten_2026"
...
- **Python 3.8+** (für Quellcode-Betrieb)
...
Die fachlichen Tarifdaten für 2026 liegen zusätzlich in `src/tax_data_2026.py`, während generische Berechnungsfunktionen in `src/tax_engine.py` vorbereitet sind.
